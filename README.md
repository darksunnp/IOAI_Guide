...
Content lives in [`content/content.json`](content/content.json), written to disk (it persists on server). Once you're signed in as an **admin** (step 3), the **Manage Content** page lets you:
